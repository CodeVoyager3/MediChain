...
public interface AccessGrantRepository extends JpaRepository<AccessGrant, UUID> {
	...
	// Used to quickly find and delete a grant when a patient hits the "Revoke" button
	Optional<AccessGrant> findByPatientAddressIgnoreCaseAndViewerAddressIgnoreCaseAndRecordId(
