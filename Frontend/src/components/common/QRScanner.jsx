      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-sm sm:max-w-md bg-white dark:bg-neutral-900 rounded-[20px] sm:rounded-[24px] shadow-2xl border-[1.6px] flex flex-col overflow-hidden h-fit transition-colors"
          >
            {/* Header */}
            <div className="flex items-center justify-between bg-neutral-50 dark:bg-neutral-800 border-b-[1.5px] px-4 sm:px-5 py-2.5 sm:py-3 transition-colors">
            ...
            <div className="flex-1 px-5 sm:px-6 pb-6 sm:pb-8 pt-4 sm:pt-6 space-y-4 sm:space-y-5">
              ...
              <div className="space-y-2.5 sm:space-y-3">
                <textarea
                  className="w-full p-3 sm:p-4 py-2.5 sm:py-3 rounded-lg sm:rounded-xl border-[1.5px] focus:outline-none focus:ring-1 focus:ring-indigo-500/30 transition-colors bg-white dark:bg-neutral-800 text-black dark:text-white h-32 resize-none font-mono text-xs sm:text-sm shadow-sm"
                  value={value}
              ...
              <div className="flex flex-col-reverse sm:flex-row justify-end gap-2 pt-2">
                <Button 
                  type="button" 
                  variant="outline" 
                  className="rounded-xl py-3 border text-neutral-700 dark:text-neutral-300 w-full sm:w-auto font-medium" 
                  onClick={onClose}
                >
                  Cancel
                </Button>
