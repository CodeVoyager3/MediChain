  ...
  return (
    <div className="w-full h-full flex flex-col gap-4 p-4 lg:p-6 min-w-0">
      <div className="flex flex-col xl:flex-row gap-4 min-w-0">
          ...
          {dashboardMetrics.map((metric) => {
            ...
            return (
              <Card
                ...
                <div
                  className="bg-white dark:bg-neutral-950 w-full h-full flex flex-col rounded-lg p-4 gap-4 border border-neutral-300 dark:border-neutral-800">
                  <CardHeader className="p-0 gap-1.5 w-full text-left">
                    <CardDescription className="wrap-break-word whitespace-normal">
                      {metric.label}
                    </CardDescription>
                    <CardTitle
                      className="text-xl sm:text-2xl font-bold tabular-nums break-all whitespace-normal">
                      {metric.value}
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="flex flex-wrap gap-x-3 gap-y-1.5 items-center p-0 w-full">
                    <div
                      className="flex items-center gap-1 shrink-0 font-medium whitespace-nowrap">
                      <TrendIcon
        ...
        {/* Revenue Chart */}
        <Card
          className="w-full xl:w-2xl min-w-0 shadow-none bg-neutral-200/60 dark:bg-neutral-900 p-1 gap-0 border border-neutral-300 dark:border-neutral-800 transition-colors duration-300 hover:shadow-lg">
          <div
            className="bg-white dark:bg-neutral-950 w-full h-full flex flex-col rounded-lg p-5 gap-8 border border-neutral-300 dark:border-neutral-800">
            <CardHeader className="flex flex-row items-center justify-between p-0">
              ...
              <Select
                defaultValue="month"
                onValueChange={(val) => toast.info(`Revenue graph updated to show: ${val}`)}>
                <SelectTrigger
            ...
            <CardContent className="flex flex-col gap-4 p-0">
              ...
              <div className="w-full h-48 -ml-5">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={revenueData} margin={{ left: 15, right: 0, top: 10, bottom: 0 }}>
                    <defs>
      ...
      <div className="flex flex-col lg:flex-row gap-4 min-w-0">
        <Card
          className="flex-1 min-w-0 shadow-none bg-neutral-200/60 dark:bg-neutral-900 p-1 gap-0 border border-neutral-300 dark:border-neutral-800 transition-colors duration-300 hover:shadow-lg">
          <div
            className="bg-white dark:bg-neutral-950 w-full h-full flex flex-col rounded-lg p-4 gap-4 border border-neutral-300 dark:border-neutral-800">
            <CardHeader className="flex flex-row items-center justify-between p-0">
              ...
              <Table>
                ...
                <TableBody>
                  {transactions.map((transaction) => (
                    <TableRow
                      key={transaction.id}
                      className="hover:bg-neutral-50 dark:hover:bg-neutral-800/50 transition-colors duration-300 hover:shadow-sm cursor-pointer border-transparent hover:border-neutral-200 dark:hover:border-neutral-700">
                      ...
                      <TableCell className="py-2 lg:py-4 text-right">
                        <DropdownMenu>
                          <DropdownMenuTrigger asChild>
                            <button
                              className="p-1.5 rounded-md hover:bg-neutral-200 dark:hover:bg-neutral-700 transition-colors focus:outline-none">
                          ...
                          <DropdownMenuContent align="end" className="w-40 rounded-lg shadow-lg">
                            <DropdownMenuItem
                              ...
                              onClick={() => toast.info(`Viewing details for transaction ${transaction.id}`)}>
                            ...
                            <DropdownMenuItem
                              ...
                              onClick={() => toast(
                                "Opening chat...",
                                { description: `Connecting to the buyer for ${transaction.id}.` }
                              )}>
                            ...
                            <DropdownMenuItem
                              ...
                              onClick={() => toast.error(
                                `Refund initiated`,
                                { description: `Refunding ${transaction.amount} back to the customer.` }
                              )}>
        ...
        <Card
          className="w-full lg:w-xl min-w-0 shadow-none bg-neutral-200/60 dark:bg-neutral-900 p-1 gap-0 border border-neutral-300 dark:border-neutral-800 transition-colors duration-300 hover:shadow-lg">
          <div
            className="bg-white dark:bg-neutral-950 w-full h-full flex flex-col rounded-lg p-4 gap-4 border border-border">
            <CardHeader className="flex flex-row items-center justify-between p-0">
              <CardTitle>Traffic Channel</CardTitle>
              <Select
                defaultValue="all"
                onValueChange={(val) => toast.info(`Traffic channel filtered by: ${val}`)}>
                <SelectTrigger
                  className="w-fit shrink-0 shadow-none border border-neutral-300 dark:border-neutral-800 bg-white dark:bg-neutral-950 transition-colors duration-300 cursor-pointer hover:bg-neutral-50 dark:hover:bg-neutral-900 focus:ring-0 focus:ring-offset-0 focus-visible:border-neutral-400 dark:focus-visible:border-neutral-600 focus-visible:ring-0 outline-none text-foreground">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  ...
                  <div key={channel.name} className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <div
                        ...
                        style={{ backgroundColor: channel.color }}></div>
