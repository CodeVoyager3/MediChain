      ...
      <SidebarMenu>
        {items.map((item) => (
          <SidebarMenuItem key={item.name}>
            <SidebarMenuButton asChild className="transition-colors duration-300 cursor-pointer">
        ...
        <SidebarMenuItem>
          <SidebarMenuButton
            className="text-sidebar-foreground/70 transition-colors duration-300 cursor-pointer">
