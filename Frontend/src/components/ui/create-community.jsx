      ...
      {isOpen && (
        <div
          ...
          <motion.div
            ...
            <div
              className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_0%,#000_80%)] hidden dark:block" />
          </motion.div>
          ...
          <motion.div
            ...
            <div className="flex justify-between items-start mb-4">
              <div>
                <h2
                  className="text-xl sm:text-2xl font-medium tracking-tight text-gray-900 dark:text-white">Create community</h2>
                <p
                  className="text-[13px] sm:text-[14px] mt-3 sm:mt-4 leading-relaxed max-w-full text-gray-500 dark:text-[#696969]">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div
                  className="grid grid-cols-3 mt-2.5 rounded-full p-1 relative
              ...
              <p
                className="text-center text-[13px] sm:text-[14px] pt-2 text-gray-400 dark:text-[#666666]">
            ...
            {/* Footer Buttons */}
            <div
              className="flex flex-col-reverse sm:flex-row items-center justify-end gap-3 mt-8 sm:mt-10">
              <button
                onClick={onClose}
