              ...
              <DropdownMenuTrigger asChild>
                <SidebarMenuButton
                  ...
                  <div className="grid flex-1 flex-col text-left leading-tighter">
                    ...
                    <span
                      className="truncate text-sm font-mono font-medium tracking-tight text-muted-foreground">
                      30 PRODUCTS
                    </span>
                  </div>
              ...
              <DropdownMenuContent
                ...
                {data.teams.map((team, index) => (
                  <DropdownMenuItem
                    ...
                    <div
                      className="flex size-6 items-center justify-center border border-neutral-200 dark:border-neutral-700 rounded-sm bg-neutral-50 dark:bg-neutral-900">
